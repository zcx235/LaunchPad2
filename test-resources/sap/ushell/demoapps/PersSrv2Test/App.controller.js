...
//                    "NoRecords" : "100",
            ...
            onNewEmptyContainer : function () {
                ...
                this.oPersonalizationService.createEmptyContainer(sContainerName, {validity : this._getContainerValidity() })
            ...
            onLoadPers : function () {
                ...
                this.fn = function () {
                    ...
                    key = arr[0].name;
                    arr.splice(0, 1);
                    this.oPersonalizationService.getContainer(key, {validity : this._getContainerValidity() })
                        .done(function (oContainer) {
            ...
            onDelPers : function () {
                ...
                this.fn = function () {
                    ...
                    key = arr[0].name;
                    arr.splice(0, 1);
                    this.oPersonalizationService.delContainer(key, {validity : this._getContainerValidity() })
                        .done(function (oContainer) {
                            var a;
            ...
            _deleteContainer : function (sContainerName) {
                ...
                this.oPersonalizationService.delContainer(sContainerName, {validity : this._getContainerValidity() })
                    .done(function (oContainer) {
