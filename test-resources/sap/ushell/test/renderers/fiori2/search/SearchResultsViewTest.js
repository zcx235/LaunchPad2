...
var SEL_SUGGESTION_ITEM = ".sapUshellSearchSuggestionNavItem";	
...
//                                          sap.ui.getCore().byId("sfOverlay").fireSearch({'query':text});
                                          searchModel.setSearchTerm(text);
...
asyncTest("Validate Show More button and Total Rows Count", function() {
              searchString = "mp3"; 		
                  global.ok(1 == "1", "search String: "+searchString);
				  ...
				  global.ok(1 == "1","No. of iterations: "+iterations);
				  ...
				  {  
					...
					length=$(".searchResultListItem").length;
					global.ok(true, "Result row Count: "+length)
					global.ok(1 == "1","Final count: "+length);
...
* */
var expectedSearchResultCount = new Array();
...
asyncTest("Validate Search Highlighting Feature(summary & details) multiple search terms", 57, function() {
		var searchTermsHighlight = new Array();
