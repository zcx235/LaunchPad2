...
jQuery.sap.require("ZTEST.MyRouter");
...
sap.ui.core.UIComponent.extend("ZTEST.Component", {
	metadata : {
		...
		rootView : "ZTEST.view.App",

		config : {
			resourceBundle : "i18n/messageBundle.properties",
			serviceConfig : {
				name: "Z_DEEP_STRUCTURE2_SRV",
				serviceUrl: "/LaunchPad2/proxy/sap/opu/odata/sap/Z_DEEP_STRUCTURE2_SRV/"
			}
		},

		routing : {
			config : {
				routerClass : ZTEST.MyRouter,
				viewType : "XML",
				viewPath : "ZTEST.view",
	...
	init : function() {
		...
		var oRootPath = jQuery.sap.getModulePath("ZTEST");
